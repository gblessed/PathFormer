...
def build_first_step_assignments_with_corridor(train_data, val_data, scene_bank, n_clusters, nearest_k=5, corridor_k=5, corridor_bins=8, radii=(25.0, 50.0, 100.0)):
