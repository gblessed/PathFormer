...
FINETUNE_CHECKPOINT_DIR="${FINETUNE_CHECKPOINT_DIR:-${PROJECT_DIR}/checkpoints_first_step_residual_corridor_finetune}"
RESULT_PREFIX="${RESULT_PREFIX:-foundation_finetune}"
...
echo "Running up to ${MAX_JOBS} finetune jobs in parallel"
...
for scenario in "${SCENARIOS[@]}"; do
    ...
    python "${SCRIPT_PATH}" \
        ...
        --checkpoint-dir "${FINETUNE_CHECKPOINT_DIR}" \
        --experiment-name "${safe_name}" \
...
echo "Finished finetuning and evaluating ${#SCENARIOS[@]} scenarios."
