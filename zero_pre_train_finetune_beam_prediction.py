...
def evaluate_model(model, val_loader, max_generate=26, log_to_wandb=False):
    ...
    with torch.no_grad():
        ...
        for prompts, paths, path_lengths, interactions, env, env_prop,_ in outer_bar:
            ...
            print(f"AoA Azimuth RMSE         :      {np.mean(az_errors):.4f} degrees")
