...
csv_log_file = "playground_std_fix2_final_scenario_results.csv"
...
config = {
    ...
    "experiment": f"noise_std_fix2_enc_direct_{scenario}_interacaction_all_inter_str_dec_all_repeat",
    "hidden_dim": 512,
    "n_layers": 8,
    "n_heads": 8,
