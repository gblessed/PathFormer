...
mkdir -p "${LOG_DIR}"
mkdir -p "${BEAM_HEAD_CHECKPOINT_DIR}"
...
echo "Beam head checkpoints: ${BEAM_HEAD_CHECKPOINT_DIR}"
...
for scenario in "${SCENARIOS[@]}"; do
    ...
    python "${SCRIPT_PATH}" \
        ...
        --beam-head-checkpoint-dir "${BEAM_HEAD_CHECKPOINT_DIR}" \
...
echo "Finished beam-foundation runs for ${#SCENARIOS[@]} scenarios."
