...
from models import PathDecoder, GPTPathDecoder, PathDecoderClusterEncoderAttention
...
# %%
    ...
    config = {
        ...
        "epochs": 300,
        "interaction_weight": 0.01,
        "experiment": f"noise_std_enc_direct_{scenario}_interacaction_all_inter_str_dec_all_repeat",
        "hidden_dim": 512,
        "n_layers": 8,
        "n_heads": 8,
        "use_cluster_conditioning": True,
    ...
    if config.get("use_cluster_conditioning", True):
        model = PathDecoderClusterEncoderAttention(
